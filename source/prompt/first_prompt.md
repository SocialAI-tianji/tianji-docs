...
Prompt：
你现在是一个善于沟通、熟悉中国问候方式、精通表达、真诚友善、言谈之中充满语言艺术的人、熟悉中国传统习俗的人。今天你要在就餐中，客气与亲朋好友交谈，增进沟通。
下面给出你的角色，聚餐的具体场景，请你依照角色说一段话活跃就餐气氛，增进感情，并在最后增加一些祝福的话语。要求：简短、真诚、亲切、客气。直接输出邀请词即可，50字以内。
具体信息： 你的角色：_____，聚餐主题：_____，聚餐场景：_____。
...
![图片](https://github.com/user-attachments/assets/e855983a-d317-45f7-9814-f71a9e4b4ecf)


Fork 之后，您就拥有了该Tianji代码仓库的副本（副本将出现在您自己账号的仓库里面）。
![图片](https://github.com/user-attachments/assets/c0227d8b-b8c1-481b-b0f9-0d06f8629578)
...
![图片](https://github.com/user-attachments/assets/81ed957b-b994-445a-8520-f9b27eebbac0)
![图片](https://github.com/user-attachments/assets/85f2be23-8d13-4b1f-84bf-a0ba6248bd52)
![图片](https://github.com/user-attachments/assets/2c41c085-6a1c-4679-8665-bb9b84109e10)



### 提交新的Prompt文件
如果您想要提交新的Prompt .md文件，请确保Prompt的格式与已有prompt保持一致：
![图片](https://github.com/user-attachments/assets/64b5fdee-bc9e-41c5-ab02-4cc9fd007c8e)


在所属的人际场景文件夹下，可以上传提交您的prompt文件
![图片](https://github.com/user-attachments/assets/47a8c0ec-2e0b-467c-afac-4f597929c506)

### 提交pr（Pull Requests）
提交更改或上传新文件之后，回到您自己的Tianji副本主页，点击“Pull requests”，进入下一个页面中，继续点击“Create pull request”
![图片](https://github.com/user-attachments/assets/eedd9ea8-6548-4bfa-91f5-5b91dee92127)

![图片](https://github.com/user-attachments/assets/3e84a772-3162-40ea-b128-48b2a95d4be5)

在这个页面中，您可以编辑title,并在Add a description区域补充您提交修改的具体情况。接着点击右下角的Create pull request.
![图片](https://github.com/user-attachments/assets/d43886c7-8eb9-4fed-8bbd-7a4a4677415d)
提交之后出现如下情况，就说明提交成功了。
![图片](https://github.com/user-attachments/assets/7810d34d-6109-4cf9-b21c-896cc9b957d6)
